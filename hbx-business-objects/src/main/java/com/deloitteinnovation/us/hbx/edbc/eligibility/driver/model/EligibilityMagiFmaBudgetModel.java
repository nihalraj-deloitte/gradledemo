...
public class EligibilityMagiFmaBudgetModel {
	...
	private BigDecimal fplLimit;

	public BigDecimal getFplLimit() {
		return fplLimit;
	}

	public void setFplLimit(BigDecimal fmaLimit) {
		this.fplLimit = fmaLimit;
	}

	private BigDecimal calculatedFPLPercentage;

	public BigDecimal getCalculatedFPLPercentage() {
		return calculatedFPLPercentage;
	}
	public void setCalculatedFPLPercentage(BigDecimal calculatedFPLPercentage) {
		this.calculatedFPLPercentage = calculatedFPLPercentage;
	}
