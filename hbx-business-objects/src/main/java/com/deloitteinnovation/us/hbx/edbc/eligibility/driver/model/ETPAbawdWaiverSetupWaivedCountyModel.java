...
public class ETPAbawdWaiverSetupWaivedCountyModel {

	private int ETPAbawdWaiverSetupWaivedCountyId;

	public int getETPAbawdWaiverSetupWaivedCountyId() {
		return ETPAbawdWaiverSetupWaivedCountyId;
	}

	public void setETPAbawdWaiverSetupWaivedCountyId(int value) {
		ETPAbawdWaiverSetupWaivedCountyId = value;
	}
	...
	private String Is15PercentExemptionCounty = "";

	public String getIs15PercentExemptionCounty() {
		return Is15PercentExemptionCounty;
	}

	public void setIs15PercentExemptionCounty(String value) {
		Is15PercentExemptionCounty = value;
	}
	...
	private String WaivedCountyName = "";

	public String getWaivedCountyName() {
		return WaivedCountyName;
	}

	public void setWaivedCountyName(String value) {
		WaivedCountyName = value;
	}
