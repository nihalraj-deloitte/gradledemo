 ...
 * generated in the com.deloitteinnovation.us.hbx.edbc.eligibility.prescreening.driver.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListGoalsRequest_QNAME = new QName("http://hbx.us.deloitteinnovation.com/ws/hbxprescreeningservice/schema", "list-goals-request");
    private final static QName _ListGoalsResponse_QNAME = new QName("http://hbx.us.deloitteinnovation.com/ws/hbxprescreeningservice/schema", "list-goals-response");
    private final static QName _ErrorResponse_QNAME = new QName("http://hbx.us.deloitteinnovation.com/ws/hbxprescreeningservice/schema", "error-response");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.deloitteinnovation.us.hbx.edbc.eligibility.prescreening.driver.service
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hbx.us.deloitteinnovation.com/ws/hbxprescreeningservice/schema", name = "list-goals-request")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hbx.us.deloitteinnovation.com/ws/hbxprescreeningservice/schema", name = "list-goals-response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hbx.us.deloitteinnovation.com/ws/hbxprescreeningservice/schema", name = "error-response")
