...
public class Eligibility {
	...
	private Collection<EligibilityIndividualMagiFmaBudget> EligibilityIndividualMagiFmaBudgets;

	public Collection<EligibilityIndividualMagiFmaBudget> getEligibilityIndividualMagiFmaBudgets() {
		return EligibilityIndividualMagiFmaBudgets;
	}

	public void setEligibilityIndividualMagiFmaBudgets(Collection<EligibilityIndividualMagiFmaBudget> value) {
		EligibilityIndividualMagiFmaBudgets = value;
	}

	private EligibilityMagiFmaBudget EligibilityMagiFmaBudget;

	public EligibilityMagiFmaBudget getEligibilityMagiFmaBudget() {
		return EligibilityMagiFmaBudget;
	}

	public void setEligibilityMagiFmaBudget(EligibilityMagiFmaBudget value) {
		EligibilityMagiFmaBudget = value;
	}
