//
// Translated by CS2J (http://www.cs2j.com): 12/14/2020 11:45:18 AM
//
...
public class EDBCLastVerifiedFinancialDetail {
    private int EDBCLastVerifiedFinancialDetailId;

    public int getEDBCLastVerifiedFinancialDetailId() {
        return EDBCLastVerifiedFinancialDetailId;
    }

    public void setEDBCLastVerifiedFinancialDetailId(int value) {
        EDBCLastVerifiedFinancialDetailId = value;
    }
    ...
    public void setFinancialDetailId(int value) {
        FinancialDetailId = value;
    }

    private int FinancialDetailAmountId;

    public int getFinancialDetailAmountId() {
        return FinancialDetailAmountId;
    }

    public void setFinancialDetailAmountId(int value) {
