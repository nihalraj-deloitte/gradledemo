 ...
 * generated in the com.deloitteinnovation.us.hbx.ws.hbxdocumentrequestservice.schema package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListGoalsRequest_QNAME = new QName("http://hbx.us.deloitteinnovation.com/ws/hbxdocumentrequestservice/schema", "list-goals-request");
    private final static QName _ListGoalsResponse_QNAME = new QName("http://hbx.us.deloitteinnovation.com/ws/hbxdocumentrequestservice/schema", "list-goals-response");
    private final static QName _ErrorResponse_QNAME = new QName("http://hbx.us.deloitteinnovation.com/ws/hbxdocumentrequestservice/schema", "error-response");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.deloitteinnovation.us.hbx.ws.hbxdocumentrequestservice.schema
     * 
     */
    ...
    /**
     * Create an instance of {@link EntityVerificationTypeInstanceType }
     * 
     */
    public EntityVerificationTypeInstanceType createEntityVerificationTypeInstanceType() {
        return new EntityVerificationTypeInstanceType();
    }
    ...
    /**
     * Create an instance of {@link EntityVerificationTypeEntityListType }
     * 
     */
    public EntityVerificationTypeEntityListType createEntityVerificationTypeEntityListType() {
        return new EntityVerificationTypeEntityListType();
    }
    ...
    /**
     * Create an instance of {@link EntityIndividualInstanceType.Relationships }
     * 
     */
    public EntityIndividualInstanceType.Relationships createEntityIndividualInstanceTypeRelationships() {
        return new EntityIndividualInstanceType.Relationships();
    }
    ...
    /**
     * Create an instance of {@link EntityVerificationTypeInstanceType.Relationships }
     * 
     */
    public EntityVerificationTypeInstanceType.Relationships createEntityVerificationTypeInstanceTypeRelationships() {
        return new EntityVerificationTypeInstanceType.Relationships();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hbx.us.deloitteinnovation.com/ws/hbxdocumentrequestservice/schema", name = "list-goals-request")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hbx.us.deloitteinnovation.com/ws/hbxdocumentrequestservice/schema", name = "list-goals-response")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link java.lang.Error }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://hbx.us.deloitteinnovation.com/ws/hbxdocumentrequestservice/schema", name = "error-response")
    public JAXBElement<java.lang.Error> createErrorResponse(java.lang.Error value) {
        return new JAXBElement<java.lang.Error>(_ErrorResponse_QNAME, java.lang.Error.class, null, value);
    }
