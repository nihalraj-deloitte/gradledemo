 ...
 * generated in the com.deloitteinnovation.us.hbx.enrollment.specialenrollment.driver.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _ErrorResponse_QNAME = new QName("http://hbx.us.deloitteinnovation.com/ws/hbxspecialenrollmentservice/schema", "error-response");
    private final static QName _ListGoalsResponse_QNAME = new QName("http://hbx.us.deloitteinnovation.com/ws/hbxspecialenrollmentservice/schema", "list-goals-response");
    private final static QName _ListGoalsRequest_QNAME = new QName("http://hbx.us.deloitteinnovation.com/ws/hbxspecialenrollmentservice/schema", "list-goals-request");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.deloitteinnovation.us.hbx.enrollment.specialenrollment.driver.service
     * 
     */
    ...
    /**
     * Create an instance of {@link LifeeventchangeInstanceType.Relationships }
     * 
     */
    public LifeeventchangeInstanceType.Relationships createLifeeventchangeInstanceTypeRelationships() {
        return new LifeeventchangeInstanceType.Relationships();
    }
    ...
    /**
     * Create an instance of {@link LifeeventchangeInstanceType }
     * 
     */
    public LifeeventchangeInstanceType createLifeeventchangeInstanceType() {
        return new LifeeventchangeInstanceType();
    }
    ...
    /**
     * Create an instance of {@link LifeeventchangeEntityListType }
     * 
     */
    public LifeeventchangeEntityListType createLifeeventchangeEntityListType() {
        return new LifeeventchangeEntityListType();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hbx.us.deloitteinnovation.com/ws/hbxspecialenrollmentservice/schema", name = "error-response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hbx.us.deloitteinnovation.com/ws/hbxspecialenrollmentservice/schema", name = "list-goals-response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hbx.us.deloitteinnovation.com/ws/hbxspecialenrollmentservice/schema", name = "list-goals-request")
