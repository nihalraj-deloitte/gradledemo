...
public class ETPAbawdWaiverSetupVolunteerCountyModel {

	private int ETPAbawdWaiverSetupVolunteerCountyId;

	public int getETPAbawdWaiverSetupVolunteerCountyId() {
		return ETPAbawdWaiverSetupVolunteerCountyId;
	}

	public void setETPAbawdWaiverSetupVolunteerCountyId(int value) {
		ETPAbawdWaiverSetupVolunteerCountyId = value;
	}
	...
	private String VolunteerCountyName = "";

	public String getVolunteerCountyName() {
		return VolunteerCountyName;
	}

	public void setVolunteerCountyName(String value) {
		VolunteerCountyName = value;
	}
