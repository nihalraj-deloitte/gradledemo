...
public class ETPAbawdCountyMappingModel {

	private int ETPAbawdCountyMappingId;

	public int getETPAbawdCountyMappingId() {
		return ETPAbawdCountyMappingId;
	}

	public void setETPAbawdCountyMappingId(int value) {
		ETPAbawdCountyMappingId = value;
	}

	private Integer ETPAbawdEffectiveDatesId;

	public Integer getETPAbawdEffectiveDatesId() {
		return ETPAbawdEffectiveDatesId;
	}

	public void setETPAbawdEffectiveDatesId(Integer value) {
	...
	private String ETPCountyCode = "";

	public String getETPCountyCode() {
		return ETPCountyCode;
	}

	public void setETPCountyCode(String value) {
		ETPCountyCode = value;
	}
