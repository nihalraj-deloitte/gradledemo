 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://hbx.us.deloitteinnovation.com/ws/hbxprescreeningservice/schema}dateDataType">
 *       &lt;sequence>
 *         &lt;element name="change-point" type="{http://hbx.us.deloitteinnovation.com/ws/hbxprescreeningservice/schema}dateChangePoint" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends DateDataType
{
    ...
    protected List<DateChangePoint> changePoint;
     ...
     * {@link DateChangePoint }
     * 
     * 
     */
    public List<DateChangePoint> getChangePoint() {
        if (changePoint == null) {
            changePoint = new ArrayList<DateChangePoint>();
        }
