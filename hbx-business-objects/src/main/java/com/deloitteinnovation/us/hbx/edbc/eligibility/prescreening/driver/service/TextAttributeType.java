 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://hbx.us.deloitteinnovation.com/ws/hbxprescreeningservice/schema}textDataType">
 *       &lt;sequence>
 *         &lt;element name="change-point" type="{http://hbx.us.deloitteinnovation.com/ws/hbxprescreeningservice/schema}textChangePoint" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends TextDataType
{
    ...
    protected List<TextChangePoint> changePoint;
     ...
     * {@link TextChangePoint }
     * 
     * 
     */
    public List<TextChangePoint> getChangePoint() {
        if (changePoint == null) {
            changePoint = new ArrayList<TextChangePoint>();
        }
